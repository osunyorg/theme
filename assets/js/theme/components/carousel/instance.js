...
window.osuny.carousel.Instance = function Instance(domElement, domClasses) {
    this.i18n = { // TODO trouver comment récuperer depuis yml
    ...
    this.domElements.root = domElement;
