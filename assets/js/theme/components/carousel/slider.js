...
//     var firstSlideNumber = parseInt(this.domElement.children.item(0).getAttribute("id").slice(-1));
//     var delta = this.position + this.size(); // delta centré doit être 0
//     var direction = Math.sign(delta);
//     var offsetValue = firstSlideNumber - this.current;
//     console.log("current:", this.current, "deltaPos:", delta, "offset:", offsetValue);

//     var nOffset = delta % this.size();
//     // console.log(nOffset);
